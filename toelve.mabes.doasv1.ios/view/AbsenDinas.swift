...
class AbsenDinas: Boyke,UITextFieldDelegate {
    ...
    private let headerLabel: UILabel = {
        let label = UILabel()
        label.text = "Ambil Foto Surat Keterangan Dinas"
    ...
    private func onKirim() {
        ...
        print("🔍 [ABSEN Dinas] Params: \(params)")
        ...
        authManager.uploadFoto(
            ...
            onError: { [weak self] message in
                ...
                print("❌ [ABSEN Dinas] Upload ERROR: \(message)")
            ...
            onLogout: { [weak self] message in
                ...
                print("🔐 [ABSEN Dinas] Upload LOGOUT: \(message)")
