...
class AbsenHadir: Boyke {
    ...
    private let headerLabel: UILabel = {
        let label = UILabel()
        label.text = "Ambil Foto Lokasi Absen"
    ...
    private func setupConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            btnSwitch.bottomAnchor.constraint(equalTo: layoutButton.topAnchor, constant: -12),
            btnSwitch.widthAnchor.constraint(equalToConstant: 60),
            btnSwitch.heightAnchor.constraint(equalToConstant: 60),
            
            // Layout Button
            layoutButton.topAnchor.constraint(equalTo: cardCameraView.bottomAnchor, constant: 16),
    ...
    private func startFlow() {
        ...
        absensiManager.authenticate { [weak self] in
            ...
            self.absensiManager.prepare(modeAbsensi: .PERLU_LOKASI)
    ...
    private func onKirim() {
        ...
        var params: [String: String] = [
            "menu": "HADIR",
            "latitude": String(absensiManager.lat ?? 0),
            "longitude": String(absensiManager.lon ?? 0),
            "jam": jam ?? ""
        ]
